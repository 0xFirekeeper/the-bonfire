// Filename: SwipeManager.cs
// Author: 0xFirekeeper
// Description: Really useful and generic Swipe direction tracker for general use on UI/World elements.
//              Inspired by a multitude of forums, last iteration of my other swipe trackers.
...
public class SwipeManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            print("SWIPE RIGHT SIDE");

        }

        if (SwipeManager.IsSwipingLeft())
        {
            print("SWIPE LEFT SIDE");
